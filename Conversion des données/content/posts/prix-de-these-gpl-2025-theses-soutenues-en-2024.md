...
décerné par le GDR SDL

date limite de candidature : vendredi 17 mars 2025

Créé en 2013 pour récompenser chaque année une excellente thèse préparée au sein du Groupement de Recherche Sciences du Logiciel (GDR SDL),  
ce prix a pour objectif de promouvoir les travaux du GDR SDL auprès de la communauté informatique, qu'ils soient fondamentaux ou appliqués.  
La sélection du prix sera faite par un jury d'universitaires et de chercheurs(cheuses).  
La remise oﬃcielle du prix aura lieu lors des prochaines journées nationales du GDR SDL qui se dérouleront en juin 2025.  
À cette occasion, le ou la lauréat(e) se verra remettre un prix.

Les thèmes scientifiques du GDR SDL sont présentés dans les motivations et enjeux du GDR (<https://gdr-gpl.cnrs.fr/?page_id=18>) et développés dans le cadre des groupes de travail qui le composent (<https://gdr-gpl.cnrs.fr/?page_id=27>). Plus généralement il s’agit des enjeux associés aux sciences du logiciel.
...
16-19 juin 2025 : journées du GDR SDL
...
L’association avec le GDR SDL doit être si possible précisée (par exemple candidat(e) ou encadrant(e) inscrit dans l’un des GT ou y ayant fait une présentation, lien à un enjeu).
