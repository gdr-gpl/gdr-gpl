...
Les thèmes scientifiques du GDR GPL sont présentés dans les motivations et enjeux du GDR ({{< link title="GDR GPL url">}}bienvenue-site-gpl/motivation/) et développés dans le cadre des groupes de travail qui le composent ({{< link title="GDR GPL url">}}group/). Plus généralement il s’agit des enjeux associés aux sciences du logiciel.
